...
tailscale up --accept-dns=false --advertise-routes=10.254.1.0/24  --advertise-exit-node

tailscale up --advertise-routes=192.168.0.0/24 --advertise-exit-node --accept-dns=false
```
